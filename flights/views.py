...
from .serializers import FlightSerializer, BookingSerializer, BookingDetailsSerializer, UpdateBookingSerializer, RegisterSerializer, BasicAccountSerializerUser
...
class BookingsList(ListAPIView):
	queryset = Booking.objects.filter(date__gte=datetime.today())  # can i keep this ? 
...
class UpdateBooking(RetrieveUpdateAPIView):
	...
	def get_serializer_class(self):
		...
		return BasicAccountSerializerUser
